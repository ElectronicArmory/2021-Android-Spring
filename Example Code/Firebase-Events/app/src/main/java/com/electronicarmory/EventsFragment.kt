 ...
 * [EventsFragment.OnListFragmentInteractionListener] interface.
 */
class EventsFragment : Fragment() {
    ...
    private lateinit var viewAdapter: EventsRecyclerViewAdapter
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = EventsRecyclerViewAdapter(EventsController.eventsArray, listener)
                viewAdapter = adapter as EventsRecyclerViewAdapter
            }
        }
        return view
    }
